...
class Activity(db.Model):
    ...
    payload = db.Column(db.JSON)  # Payload je obično JSON tip podataka
...
class SearchHistory(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('users.user_id'), nullable=False)from flask_sqlalchemy import SQLAlchemy
from datetime import datetime
